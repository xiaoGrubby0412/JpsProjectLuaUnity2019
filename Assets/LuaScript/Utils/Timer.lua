...
function Timer:Start()
	...
	EventManager.AddListener(EventID.On_MonoBehavior_Update, self, self.Update)
end
...
function Timer:Stop()
	...
	EventManager.RemoveListener(EventID.On_MonoBehavior_Update, self, self.Update)
end
...
function FrameTimer:Start()		
	...
	EventManager.AddListener(EventID.On_MonoBehavior_CoUpdate, self, self.Update)
	self.running = true
end
...
function FrameTimer:Stop()	
	...
	EventManager.RemoveListener(EventID.On_MonoBehavior_CoUpdate, self, self.Update)
end
